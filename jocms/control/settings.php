...
<body >
    ...
    <p>jocms <?php echo $JO_LANG['SET_VERS']; ?> 0.7 <a href="http://jocms.rusciori.org/updates.php" class="jo_btn"><?php echo $JO_LANG['SET_UPD']; ?></a> <a href="mailto:jocms@rusciori.org" class="jo_btn"><?php echo $JO_LANG['SET_REP']; ?></a> </p>
    <?php
    if($error != ""){
      echo '
